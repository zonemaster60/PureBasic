...
- **BUILD**: Available only in the AdventureGen builder. It writes the current selection into the project's `src\current_config.pbi` and attempts to compile `GeneratedAdventure.exe` with `pbcompiler`.
