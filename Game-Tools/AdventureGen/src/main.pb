...
Procedure.s GetGeneratedBaseName()
  ...
  Protected DotPos.i = FindString(Name, ".", Len(Name) - 3)
...
Procedure.b WriteStandaloneBuildSource(SourceFile.s, OutputSourceFile.s)
  Protected InputFile.i, OutputFile.i
  Protected Line.s
...
Procedure PrintGameHelp()
  ...
  Else
    PrintN("Commands: N, S, E, W, LOOK, INV, HELP, EXIT")
  EndIf
EndProcedure
...
Procedure ExportStandalone()
  ...
  Protected SourceDirectory.s, ConfigFile.s, OutputFile.s, IconFile.s, CompilerArgs.s, BuildSourceFile.s
  ...
  If WriteStandaloneBuildSource(SourceFile, BuildSourceFile) = #False
