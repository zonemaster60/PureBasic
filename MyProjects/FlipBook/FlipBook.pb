...
; The code is free - no restrictions,
; do whatever you want With it

; 09/16/23 added file dialog box to select file
; other small fixes
...
CompilerIf #PB_Compiler_IsMainFile
  ...
  Define filename.s=OpenFileRequester("Open a file", "",
                                      "CMD Files|*.bat;*.cmd|PB Files|*.pb;*.pbi|Text Files|*.txt|All Files|*.*",0)
  Define filename2.s=GetFilePart(filename)
   OpenWindow(0,0,0,800,600,"FlipBook ("+vers+") - Viewing file: '"+filename2+"'",#PB_Window_ScreenCentered | #PB_Window_SystemMenu)
   ...
   *book.FlipBook = New(0, (GadgetWidth(0) - 5) * 0.75, GadgetHeight(0) * 0.5, GadgetWidth(0) * 0.5 - 10, GadgetHeight(0) - 20, RGBA(32,32,32,255))
   ...
   Else
      ...
      DrawVectorParagraph("FlipBook" + #CRLF$ + #CRLF$ + "'" + filename2 + "'" + #CRLF$ + #CRLF$,*book\width,*book\height,#PB_VectorParagraph_Center)     
      StopVectorDrawing()
...
; EnableUser
; DPIAware
; UseIcon = flipbook.ico
; Executable = FlipBook.exe