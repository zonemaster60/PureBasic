...
Procedure ProGUI_EventCallback(hwnd, message, wParam, lParam)
    ...
    Select message
        ...
        Case #WM_SIZE
            ...
            margin = 40
            ;ResizeGraph(graph, margin, margin, WindowWidth(#Window_0)-(margin*2), WindowHeight(#Window_0)-(margin*2), 0)
...
Procedure Open_Window_0()
    ...
    graph = CreateGraph(#ProGUI_Any, WindowID(#Window_0), 10, 10, 500, 500)
    ...
    ;SetGraphTickSize(graph, 8, 2, 80, 0)
    ;SetGraphGridlines(graph, #True, MakeColour(155, 0, 0, 255), 1, #True, MakeColour(65, 0, 0, 255), 1, #False, MakeColour(255, 0, 0, 255), 1, 0)
    ;SetGraphGridlines(graph, #True, MakeColour(155, 0, 0, 255), 10, #True, MakeColour(65, 0, 0, 255), 10, 0)
    ...
    ln(5)\x = 9 : ln(5)\y = 8
    ln(6)\x = 11 : ln(6)\y = 4
    AddGraphLine(graph, ln(), MakeColor(255, 0, 0, 255), 0, #GL_Line_Style_Dash, "This is a line", #GL_Line_Node_Dot, 0, 0, #True, #True, 0)
    ...
    ln(3)\x = 4 : ln(3)\y = 3
    ln(4)\x = 5 : ln(4)\y = 7
    AddGraphLine(graph, ln(), MakeColor(155, 255, 0, 0), 0, 0, "Weeeee!", #GL_Line_Node_Diamond, 0, 0, #True, #False, 0)
    ...
    ln(3)\x = 4 : ln(3)\y = 8
    ln(4)\x = 5 : ln(4)\y = 14
    AddGraphLine(graph, ln(), MakeColor(255, 0, 100, 0), 0, 0, "Test line label", #GL_Line_Node_Star, 0, 0, #True, #False, 0)
    ...
    ln(3)\x = -6 : ln(3)\y = 4
    ln(4)\x = -7 : ln(4)\y = 5
    AddGraphLine(graph, ln(), MakeColor(255, 200, 0, 200), 1, 0, "grrrr", #GL_Line_Node_Cross, 0, #False, #True, #False, 0)
    ...
    ln(3)\x = -6 : ln(3)\y = -4
    ln(4)\x = -7 : ln(4)\y = -5
    AddGraphLine(graph, ln(), MakeColor(255, 155, 155, 0), 3, 0, "poo!", #GL_Line_Node_Triangle, 0, #False, #True, #False, 0)
    
    graph2 = CreateGraph(#ProGUI_Any, WindowID(#Window_0), 510, 10, 500, 500)
    ...
    ; ln(3)\x = 5 : ln(3)\y = 9
    ; ln(4)\x = 8 : ln(4)\y = 10
    ; AddGraphLine(graph2, ln(), MakeColor(255, 155, 0, 255), "Hellooo", 0)
    ; 
    ; ln(0)\x = 1 : ln(0)\y = 0
    ; ln(1)\x = 2 : ln(1)\y = 2
    ; ln(2)\x = 3 : ln(2)\y = 3
    ; ln(3)\x = 4 : ln(3)\y = 4
    ; ln(4)\x = 5 : ln(4)\y = 5
    ; AddGraphLine(graph2, ln(), MakeColor(155, 255, 155, 0), "rararara!", 0)
    ; 
    ; ln(0)\x = -5 : ln(0)\y = 2
    ; ln(1)\x = 2 : ln(1)\y = 4
    ; ln(2)\x = 3 : ln(2)\y = 9
    ; ln(3)\x = 4 : ln(3)\y = 20
    ; ln(4)\x = 5 : ln(4)\y = 14
    ; AddGraphLine(graph2, ln(), MakeColor(255, 55, 100, 0), "Nice!", 0)
    ; 
    ; AddGraphRange(graph2, 2, 8, 0, 10, MakeColour(100, 255, 0, 255), "A nice range", 0)
    ; AddGraphRange(graph2, 20, 40, 0, 10, MakeColour(100, 50, 255, 100), "another", 0)
    ...
    ;density1 = AddGraphDensityPlot(graph2, 0, 20, 0, 20, vals(), MakeColour(255, 255, 0, 0), MakeColour(255, 0, 255, 0), "Density Plot", @testCallback(), 0)
    ...
    density2 = AddGraphDensityPlot(graph2, 0, 20, 0, 20, vals(), MakeColour(255, 0, 255, 0), MakeColour(255, 0, 0, 255), "Density Plot2", 0, 0)
    ...
    bars = AddGraphBars(graph, bar(), #False, 0)
    ...
    bars2 = AddGraphBars(graph, bar(), #True, 0)
    ...
    AddGraphPolyRange(graph, "Poly Range", MakeColour(100, 255, 0, 0), p(), 1, 5, 1, 1, 0)
