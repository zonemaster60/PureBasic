...
Procedure E_CHECK_IF_SCREEN_BORDER_ACTIVE()
  ;this is for single screen games only! or for screens with no scrolling
  ;this will prevent object to move out of the screen, even if there is no collison/border set
  
  If e_engine\e_use_screen_border<1
  ProcedureReturn #False
  EndIf
  ...
  Select world_object()\object_move_direction_x
    ...
    Case #LEFT
       ...
       If (world_object()\object_x+e_engine\e_world_offset_x)<e_engine\e_border_left
        world_object()\object_move_direction_x=#NO_DIRECTION
    ...
    Case #RIGHT
       ...
       If (world_object()\object_x+e_engine\e_world_offset_x)>e_engine\e_border_right
        world_object()\object_move_direction_x=#NO_DIRECTION
        ProcedureReturn #True
      EndIf
  ...
  Select world_object()\object_move_direction_y
    ...
    Case #UP
       ...
       If (world_object()\object_y+e_engine\e_world_offset_y)<e_engine\e_border_top
        world_object()\object_move_direction_y=#NO_DIRECTION
        ProcedureReturn #True
      EndIf
    ...
    Case #DOWN
       ...
       If (world_object()\object_y+e_engine\e_world_offset_y)>e_engine\e_border_bottom
        world_object()\object_move_direction_y=#NO_DIRECTION
        ProcedureReturn #True
      EndIf
...
EndIf
 ...
 EndIf
   ...
   If  E_CHECK_IF_SCREEN_BORDER_ACTIVE()=#True
   ProcedureReturn #False  
   EndIf
...
; 
  ...
  Procedure E_EMITTER_CORE_HANDLER()
    ...
    Procedure E_SETUP_ISO_Y()
      ;here we go for the isometricx system
      If world_object()\object_use_isometric=#True
        world_object()\object_virtual_y=world_object()\object_y+world_object()\object_h  
      EndIf
    EndProcedure
