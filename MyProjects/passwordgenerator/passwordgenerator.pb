...
Repeat
  ...
  For i=1 To n_of_pw    
    Repeat      
      ...
      Wend
    Until CheckPW(pwstr)
    PrintN(RSet(Str(i),Len(Str(n_of_pw))," ")+") user:"+pname+" pass:"+pwstr+" www:"+wname)
    WriteStringN(0, RSet(Str(i),Len(Str(n_of_pw))," ")+") user:"+pname+" pass:"+pwstr+" www:"+wname)
    pwstr=""
  Next
  PrintN("")
  CloseFile(0)
