...
; Demonstrates how to use rebars, how to put a menuex in a rebar
...
Procedure Open_Window_0()
  ...
  OpenWindow(#Window_0, 50, 50, 800, 500, "RebarExample 1: A simple rebar containing a menu", #PB_Window_ScreenCentered | #PB_Window_SizeGadget | #PB_Window_MinimizeGadget | #PB_Window_MaximizeGadget | #PB_Window_Invisible)
  ...
  ; create a rebar
  CreateRebar(#REBAR_0, WindowID(#Window_0), 0, #RBS_BANDBORDERS, 0)
...
; EnableXP
; EnableUser
; Executable = RebarExample1(x64).exe