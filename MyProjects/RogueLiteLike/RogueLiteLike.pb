...
Procedure ShowTitle()
  ...
  GameState = "title"
  TitleX.f = (GameWidth - Len("RogueLite") * 32) / 2
  TitleY.f = (GameHeight / 2 - 110)
  DrawBitmapText(TitleX, TitleY, "RogueLite", 32, 48)
...
Procedure RenderFrame()
  ...
  FlipBuffers()
EndProcedure
If OpenWindow(0, 0, 0, GameWidth, GameHeight, "RogueLiteLike", #PB_Window_SystemMenu | #PB_Window_ScreenCentered)
